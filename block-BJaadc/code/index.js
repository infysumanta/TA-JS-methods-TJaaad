...
console.log(
  `The last character of (${message}) is '${message.charAt(
    message.length - 1
  )}'`
);
...
console.log(
  `Index of 'you' in the (${message}) is '${message.indexOf("you")}'`
);

// Log the index of word "still" in message

console.log(
  `Index of 'still' in the (${message}) is '${message.indexOf("still")}'`
);

// Log the index of word "answers" in message

console.log(
  `Index of 'answers' in the (${message}) is '${message.indexOf("answers")}'`
);

// Log true or false based on whether the word "answers" exist in message or not

console.log(`answers = ${message.includes("answers")}`);
